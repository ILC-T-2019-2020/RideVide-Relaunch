...
CAMPUS_LOCATION_CHOICES = [
    ('Campus', 'Campus'),
]

OFF_CAMPUS_LOCATION_CHOICES = [
...
ALL_LOCATION_CHOICES = [
    ('All', 'All')
] + CAMPUS_LOCATION_CHOICES + OFF_CAMPUS_LOCATION_CHOICES
...
class AddRideForm(forms.Form):
    ...
    time = forms.TimeField(widget=DateTimePicker(options={
        "pickDate": False,
    }),
...
class AddFromCampusRideForm(AddRideForm):
    ...
    departure = 'Campus'
    destination = forms.ChoiceField(choices=OFF_CAMPUS_LOCATION_CHOICES)


class AddToCampusRideForm(AddRideForm):
    departure = forms.ChoiceField(choices=OFF_CAMPUS_LOCATION_CHOICES)
...
class FilterRidesForm(forms.Form):
    ...
    departure = forms.ChoiceField(required=False, choices=ALL_LOCATION_CHOICES)
